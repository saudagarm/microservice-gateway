  ...
  return {
    plugins: [
      new ModuleFederationPlugin({
        remotes: {
          payment: 'payment@/services/payment/remoteEntry.js',
          collection: 'collection@/services/collection/remoteEntry.js',
          master: 'master@/services/master/remoteEntry.js',
          cards: 'cards@/services/cards/remoteEntry.js',
        },
        shared: {
